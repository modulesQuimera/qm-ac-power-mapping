module.exports = function(RED) {
    ...
    function mappingSetVoltagetNode(config) {
    ...
    RED.nodes.registerType("mapping-voltage", mappingSetVoltagetNode);
};